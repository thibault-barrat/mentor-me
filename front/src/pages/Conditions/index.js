		...
		<>
			<main className='conditions'>
				<div className='conditions__header'>
					<h1 className='conditions__header__title'>Conditions générales</h1>
					<p className='conditions__header__text'>En vigueur au 10/11/2021</p>
				</div>
				<div className='conditions__container'>
					<p className='conditions__container__text'>
						...
						disposition du site et des services par Mentor.me et de définir les
						...
						«Conditions générales». Les CGU doivent être acceptées par tout
						Utilisateur souhaitant accéder au site. Elles constituent le contrat
						entre le site et l'Utilisateur. L’accès au site par l’Utilisateur
						signifie son acceptation des présentes CGU. Toute inscription ou
						utilisation du site implique l'acceptation sans aucune réserve ni
						restriction des présentes CGU par l’utilisateur. Lors de
						l'inscription sur le site via le Formulaire d’inscription, chaque
						utilisateur accepte expressément les présentes conditions générales
						en cochant la case précédant le texte suivant : « J'accepte les
						conditions générales et la politique de confidentialité ». En cas de
						...
						par le site. Mentor.me se réserve le droit de modifier
						unilatéralement et à tout moment le contenu des présentes CGU.
					</p>
					<h2 className='conditions__container__title'>Accès au site</h2>
					<p className='conditions__container__text'>
						...
						s’inscrire en remplissant le formulaire d’inscription. En acceptant
						...
						civil et ses coordonnées, notamment son adresse email. L’Utilisateur
						est responsable de la mise à jour des informations fournies. Il lui
						est précisé qu’il peut les modifier en se connectant à son espace
						membre. Pour accéder aux services, l’Utilisateur devra s'identifier
						à l'aide de son nom d’utilisateur et de son mot de passe qui lui
						seront communiqués après son inscription et qui sont strictement
						...
						email à : mentorme.contact@gmail.com. Celle-ci sera effective dans
						un délai raisonnable. En cas de non respect des conditions générales
						de vente et/ou d’utilisation, le site Mentor.me aura la possibilité
						de suspendre voire de fermer le compte d’un Utilisateur après mise
						en demeure adressée par voie électronique et restée sans effet.
						...
						l’Utilisateur. Tout événement dû à un cas de force majeure ayant
						...
						n'engage pas la responsabilité de Mentor.me.
					</p>
					<h2 className='conditions__container__title'>Données personnelles</h2>
					<p className='conditions__container__text'>
					...
					<p className='conditions__container__text'>
						...
						et publicitaires est strictement interdite. Il est rappelé
					...
					<h2 className='conditions__container__title'>Responsabilité</h2>
					<p className='conditions__container__text'>
						Les sources des informations diffusées sur le site Mentor.me sont
						...
						contractuelle. Malgré des mises à jour régulières, le site Mentor.me
						...
						Le site Mentor.me ne peut être tenu pour responsable d’éventuels
					...
					<h2 className='conditions__container__title'>Liens hypertextes</h2>
					<p className='conditions__container__text'>
						Des liens hypertextes peuvent être présents sur le site.
						L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira
						du site Mentor.me. Ce dernier n’a pas de contrôle sur les pages web
						sur lesquelles aboutissent ces liens et ne saurait, en aucun cas,
					...
					<p className='conditions__container__text'>
						Le site permet aux membres de publier des services. Dans ses
						publications, le membre s’engage à respecter les règles de la
						...
						intellectuelle. Mais en publiant un service sur le site, il cède à
						Mentor.me le droit non exclusif et gratuit de représenter,
						reproduire, adapter, modifier, diffuser et distribuer sa
						publication, directement ou par un tiers autorisé, dans le monde
						...
						téléphonie mobile. Mentor.me s'engage à faire figurer le nom du
						...
						modifié par le site, sans préavis. Pour toute question relative à
						l’application des présentes CGU, vous pouvez joindre l’équipe de
						Mentor.me à l’adresse mail suivante :{' '}
						<a href='mailto:mentorme.contact@gmail.com'>
							<em>mentorme.contact@gmail.com</em>
						</a>
						.
					</p>
				</div>
